# This Makefile is for the SendGrid extension to perl.
#
...
MAKEMAKER   = /Library/Perl/Updates/5.12.3/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.66
MM_REVISION = 66600
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Mail/SendGrid/Header.pm $(INST_MAN3DIR)/Mail::SendGrid::Header.$(MAN3EXT) \
	  lib/Mail/SendGrid/Transport/REST.pm $(INST_MAN3DIR)/Mail::SendGrid::Transport::REST.$(MAN3EXT) \
	  lib/Mail/SendGrid.pm $(INST_MAN3DIR)/Mail::SendGrid.$(MAN3EXT) \
	  lib/Mail/SendGrid/Transport/Sendmail.pm $(INST_MAN3DIR)/Mail::SendGrid::Transport::Sendmail.$(MAN3EXT) \
	  lib/Mail/SendGrid/Transport/SMTP.pm $(INST_MAN3DIR)/Mail::SendGrid::Transport::SMTP.$(MAN3EXT) 
